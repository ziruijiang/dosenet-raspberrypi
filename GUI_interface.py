...
nmerge_text.pack()
n_merge_option.pack()
period_text.pack(side=Tkinter.LEFT)
period_option.pack(side=Tkinter.LEFT, fill="x", expand=True)
location_text.pack(side=Tkinter.LEFT)
location_option.pack(side=Tkinter.LEFT, fill="x", expand=True)
