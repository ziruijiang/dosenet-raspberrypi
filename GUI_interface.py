...
nmerge_text = Label(top, text = 'Integration seconds (s)', font = "Times 16").grid(row=5, column = 2,pady = 2,columnspan =2, sticky = Tkinter.E)
...
maxdata_option.grid(row=4, column = 4,pady = 2, sticky = Tkinter.W) 
n_merge_option.grid(row=5, column = 4,pady = 2, sticky = Tkinter.W)
period_option.grid(row=6, column = 4,pady = 2, sticky = Tkinter.W) 
location_option.grid(row=7, column = 4,pady = 2, sticky = Tkinter.W)
