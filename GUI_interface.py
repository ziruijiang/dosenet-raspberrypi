...
AirButton = Tkinter.Checkbutton(top, text="Air Quality", variable=varAir, font="Times 20").grid(row=0, column = 3,pady = 3)    
WeatherButton = Tkinter.Checkbutton(top, text='Weather Sensor', variable=varWeather, font="Times 20").grid(row=1, column = 3,pady = 3)
CO2Button = Tkinter.Checkbutton(top, text="CO2 Sensor", variable=varCO2, font="Times 20").grid(row=2, column = 3,pady = 3)
d3sButton = Tkinter.Checkbutton(top, text="D3S", variable=vard3s, font="Times 20").grid(row=3, column = 3,pady = 3)
# maxdata = Entry(top)
# n_merge = Entry(top)
...
maxdata_text = Label(top, text = "Data points on plot", font = "Times 16").grid(row=4, column = 1,columnspan = 2,pady = 3, padx=3,  sticky = Tkinter.E)
nmerge_text = Label(top, text = 'Integration seconds (s)', font = "Times 16").grid(row=5, column = 1,columnspan = 2,pady = 3,padx=3, sticky = Tkinter.E)
period_text = Label(top, text = 'Period', font = "Times 16").grid(row=6, column = 1,columnspan = 2,pady = 3, padx=3,sticky = Tkinter.E)
location_text = Label(top, text = 'Location', font = "Times 16").grid(row=7, column = 1,columnspan = 2,pady = 3, padx=3, sticky = Tkinter.E)
RecordButton = Tkinter.Button(top, text="Record Data", command = weather_test, font="Times 20").grid(row=8, column = 3,pady=5)
 
maxdata_option.grid(row=4, column = 3,columnspan = 2,pady = 2,sticky = Tkinter.E) 
n_merge_option.grid(row=5, column = 3,columnspan = 2,pady = 2,sticky = Tkinter.E)
period_option.grid(row=6, column = 3,columnspan = 2,pady = 2,sticky = Tkinter.E) 
location_option.grid(row=7, column = 3,columnspan = 2,pady = 2,sticky = Tkinter.E)
