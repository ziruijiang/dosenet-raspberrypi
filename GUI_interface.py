...
maxdata_option.grid(row=4, column = 3,pady = 2, sticky = Tkinter.W) 
n_merge_option.grid(row=5, column = 3,pady = 2, sticky = Tkinter.W)
period_option.grid(row=6, column = 3,pady = 2, sticky = Tkinter.W) 
location_option.grid(row=7, column = 3,pady = 2, sticky = Tkinter.W)
