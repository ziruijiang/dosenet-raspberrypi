...
maxdata_text = Label(top, text = "Data points on plot", font = "Times 16").grid(row=4, column = 2,columnspan = 2,pady = 3, padx=3,  sticky = Tkinter.E)
nmerge_text = Label(top, text = 'Integration seconds (s)', font = "Times 16").grid(row=5, column = 2,columnspan = 2,pady = 3,padx=3, sticky = Tkinter.E)
period_text = Label(top, text = 'Period', font = "Times 16").grid(row=6, column = 2,columnspan = 2,pady = 3, padx=3,sticky = Tkinter.E)
location_text = Label(top, text = 'Location', font = "Times 16").grid(row=7, column = 2,columnspan = 2,pady = 3, padx=3, sticky = Tkinter.E)
