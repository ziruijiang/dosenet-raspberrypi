...
maxdata_text = Label(left, text = "Data points on plot", font = "Times 16")
nmerge_text = Label(left, text = 'Integration seconds (s)', font = "Times 16")
period_text = Label(left, text = 'Period', font = "Times 16")
location_text = Label(left, text = 'Location', font = "Times 16")
