...
maxdata_text = Label(top, text = "Data points on plot", font = "Times 16").grid(row=4, column = 0)
nmerge_text = Label(top, text = 'Integration seconds (s)', font = "Times 16").grid(row=4, column = 2)
period_text = Label(top, text = 'Period', font = "Times 16").grid(row=5, column = 0)
location_text = Label(top, text = 'Location', font = "Times 16").grid(row=5, column = 2)
