...
maxdata_text = Label(top, text = "Data points on plot", font = "Times 16").grid(row=4, column = 1)
nmerge_text = Label(top, text = 'Integration seconds (s)', font = "Times 16").grid(row=4, column = 3)
period_text = Label(top, text = 'Period', font = "Times 16").grid(row=5, column = 1)
location_text = Label(top, text = 'Location', font = "Times 16").grid(row=5, column = 3)
RecordButton = Tkinter.Button(top, text="Record Data", command = weather_test, font="Times 20").grid(row=6, column = 2)
 
maxdata_option.grid(row=4, column = 2) 
n_merge_option.grid(row=4, column = 4)
period_option.grid(row=5, column = 2) 
location_option.grid(row=5, column = 4)
