...
maxdata_option.grid(row=4, column = 4,pady = 2) 
n_merge_option.grid(row=5, column = 4,pady = 2)
period_option.grid(row=6, column = 4,pady = 2) 
location_option.grid(row=7, column = 4,pady = 2)
