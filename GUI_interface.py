...
AirButton = Tkinter.Checkbutton(top, text="Air Quality", variable=varAir, font="Times 20").grid(row=0)    
WeatherButton = Tkinter.Checkbutton(top, text='Weather Sensor', variable=varWeather, font="Times 20").grid(row=1)
CO2Button = Tkinter.Checkbutton(top, text="CO2 Sensor", variable=varCO2, font="Times 20").grid(row=2)
d3sButton = Tkinter.Checkbutton(top, text="D3S", variable=vard3s, font="Times 20").grid(row=3)
# maxdata = Entry(top)
# n_merge = Entry(top)
...
maxdata_text = Label(top, text = "Data points on plot", font = "Times 16").grid(row=4)
nmerge_text = Label(top, text = 'Integration seconds (s)', font = "Times 16").grid(row=4)
period_text = Label(top, text = 'Period', font = "Times 16").grid(row=5)
location_text = Label(top, text = 'Location', font = "Times 16").grid(row=5)
RecordButton = Tkinter.Button(top, text="Record Data", command = weather_test, font="Times 20").grid(row=6)
 
maxdata_option.grid(row=4, column = 1) 
n_merge_option.grid(row=4, column = 3)
period_option.grid(row=5, column = 1) 
location_option.grid(row=5, column = 3)
