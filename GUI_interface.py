...
AirButton = Tkinter.Checkbutton(top, text="Air Quality", variable=varAir, font="Times 20")    
WeatherButton = Tkinter.Checkbutton(top, text='Weather Sensor', variable=varWeather, font="Times 20")
CO2Button = Tkinter.Checkbutton(top, text="CO2 Sensor", variable=varCO2, font="Times 20")
d3sButton = Tkinter.Checkbutton(top, text="D3S", variable=vard3s, font="Times 20")
# maxdata = Entry(top)
# n_merge = Entry(top)
...
maxdata_text = Label(top, text = "Data points on plot", font = "Times 16")
nmerge_text = Label(top, text = 'Integration seconds (s)', font = "Times 16")
period_text = Label(top, text = 'Period', font = "Times 16")
location_text = Label(top, text = 'Location', font = "Times 16")
RecordButton = Tkinter.Button(top, text="Record Data", command = weather_test, font="Times 20")
...
nmerge_text.pack()
n_merge_option.pack()
period_text.pack(side=Tkinter.LEFT,anchor= Tkinter.CENTER)
period_option.pack(side=Tkinter.LEFT, anchor= Tkinter.E)
location_text.pack(side=Tkinter.LEFT,anchor= Tkinter.CENTER)
location_option.pack(side=Tkinter.LEFT,anchor= Tkinter.E)
